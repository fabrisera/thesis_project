...
\begin{forest}
    ...
    [CDP Climate Response Survey Data\\\textbf{34,588 firm-years}, fill=blue!20
        [Frim has an ISIN code?, edge, fill=yellow!20
            ...
            [\text{9,785} (28.3 \%) firm-years dropped, edge label={node[midway, above right] {NO}}, fill=red!20]
        ]
    ]
\end{forest}
...
\begin{longtable}{lp{2cm}p{6cm}p{2cm}}
    ...
    \multicolumn{4}{l}{\textbf{Core Information}} \\
    \midrule
...
\subsection{Emissions Breakdown by Continent}

\input{tables/emission_breakdown.tex}

\subsection{Emissions Breakdown by Sector}

\input{tables/emission_breakdown_sector.tex}

\subsection{Emissions Breakdown by Country}

\input{tables/emission_breakdown_country.tex}

\subsection{Emissions Breakdown by Year}
